...
from task.wrapper import ProcessFrame84, ImageToPyTorch,MoveConstraint,TimeLimit, GrayToPyTorch
...
#                 deterministic=True,
#             )
model = SAC.load('./logs/sac/PandaTouchEnv_color-v0_16/rl_model_30000_steps.zip', env=env)
